...
os.system("sudo apt-get install mahimahi")
...
os.system("sudo apt-get install xvfb xserver-xephyr tightvncserver unzip")
# os.system("sudo apt-get install python-setuptools python-pip xvfb xserver-xephyr tightvncserver unzip")
...
os.system("sudo apt-get install python3-h5py")
os.system("sudo apt-get install python3-scipy")
